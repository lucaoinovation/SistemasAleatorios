		...
		<table width=225 cellpadding=4 height="123">
			<tr>
				<td colspan=2 height="13">
					<p>
						<div style="text-align:center;"><b>Faça seu cadastro</b></div>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td height="22" class="text-center">
					<input type="password" type=text name=username size="20">
				</td>
			</tr>
			<tr>
				<td height="22">
			...
			<tr>
				<td colspan=2 style="text-align:center;" height="26"><a href="login.php"><input type=button value="Cadastrar"  onClick="Login()"></a></td>
			</tr>
		</table>
	</form>
</div>
